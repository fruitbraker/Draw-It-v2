...
public class DashboardActivityOld extends AppCompatActivity
    ...
    private RecyclerViewAdapterDrawing mRecycleAdapter;
    ...
    private void init() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog testDialog = new Dialog(DashboardActivityOld.this);
                        ...
                        drawing.save(getApplicationContext(), new Response.Listener<ObjectModificationResponse>() {
                            ...
                            public void onResponse(ObjectModificationResponse response) {
                                ...
                                if (userID != null) {
                                    ...
                                    T.showLong(DashboardActivityOld.this, "Fatal error occurred. Logout and login again");
                            }
                        });
                    }
                });
                        ...
                        if (userObject.size() > 0) {
                            ...
                            if (drawingIDs.size() > 0) {
                                LocallySavableCMObject.loadObjects(getApplicationContext(), drawingIDs, new Response.Listener<CMObjectResponse>() {
                                    ...
                                    public void onResponse(CMObjectResponse response) {
                                        noDrawingTv.setVisibility(View.INVISIBLE);
                                        mRecycleAdapter = new RecyclerViewAdapterDrawing(getApplicationContext(), response.getObjects(), userID);
                                ...
                                mRecycleAdapter = new RecyclerViewAdapterDrawing(getApplicationContext(), dummyData, userID);
                                mRecyclerView.setAdapter(mRecycleAdapter);
                                mRecyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
