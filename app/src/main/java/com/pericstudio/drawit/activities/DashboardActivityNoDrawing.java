...
public class DashboardActivityNoDrawing extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_no_drawing);
    ...
    private void init() {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_no_drawing);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog testDialog = new Dialog(DashboardActivityNoDrawing.this);
                        ...
                        drawing.save(getApplicationContext(), new Response.Listener<ObjectModificationResponse>() {
                            ...
                            public void onResponse(ObjectModificationResponse response) {
                                ...
                                if (userID != null) {
                                    ...
                                    T.showLong(DashboardActivityNoDrawing.this, "Fatal error occurred. Logout and login again.");
                            }
                        });
                    }
                });
